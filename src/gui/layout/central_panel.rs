...
use crate::core::{ConversionType, HWAcceleration};
        ...
        egui::Frame::new()
            ...
            .show(ui, |ui| {
                ui.horizontal(|ui| {
                    ...
                    ui.vertical(|ui| {
                        ui.label(RichText::new("Conversion Mode:").strong().size(16.0));
                        
                        let type_text = match app.conversion_type {
                            ConversionType::AudioMP3  => "🎵 Audio (MP3)",
                            ConversionType::AudioAAC  => "🎵 Audio (AAC)",
                        ...
                        egui::ComboBox::from_id_salt("conv_type")
                            .selected_text(RichText::new(type_text).size(16.0).color(Color32::from_rgb(45, 50, 65)))
                            .width(280.0)
                            .show_ui(ui, |ui| {
                                ...
                                sel_val(ui, ConversionType::AudioAAC, "🎵 Audio (AAC)");
                    ...
                    ui.vertical(|ui| {
                        ui.horizontal(|ui| {
                            ui.label(RichText::new("Acceleration:").strong().size(16.0));
                        ...
                        let hw_enabled = app.conversion_type != ConversionType::VideoMKV 
                            && app.conversion_type != ConversionType::AudioMP3
                            && app.conversion_type != ConversionType::AudioAAC;
                    ...
                    if app.conversion_type != ConversionType::AudioMP3 
                        && app.conversion_type != ConversionType::AudioAAC 
                        && app.conversion_type != ConversionType::VideoMKV 
                    {
                        ui.separator();
                        ui.vertical(|ui| {
                            ui.label(RichText::new("Options:").strong().size(16.0));
